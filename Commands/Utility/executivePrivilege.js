...
const cmdDesc = "The executive privilege is the ability for someone to control mit bot into doing whatever they want it to do. It's a special power - " +
"albeit powerful, only granted to a select few. This also happens to be the only command not in mit bot documentation." + 
